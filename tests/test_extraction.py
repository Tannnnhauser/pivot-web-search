...
from pivot_web_search_mcp.extraction import _fetch_url, extract_trafilatura
...
class TestCrossHostRedirect:
    async def test_cross_host_blocked(self):
        ...
        with patch("pivot_web_search_mcp.http_client._do_request", new_callable=AsyncMock) as mock_req:
            ...
            result = await _fetch_url("https://example.com/page")
    ...
    async def test_same_host_redirect_followed(self):
        ...
        with patch("pivot_web_search_mcp.http_client._do_request", new_callable=AsyncMock) as mock_req:
            ...
            resp = await _open_with_fallback("GET", "https://example.com/old")
